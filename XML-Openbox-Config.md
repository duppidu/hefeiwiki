Im Eintrag [Einstellungen der Virtualbox](https://gitlab.com/solidus/hefei/wikis/EinstellungenDerVirtualBox#SM2.3) wird beschrieben wöfür diese Codezeilen benötigt werden.
	...
	<openbox_config xmlns="http://openbox.org/3.4/rc">
	  ...
	  <keyboard>
	    ...
	    <keybind key="XF86Search">                           
	      <action name="Execute">			       
		<command>/usr/bin/catfish --path=/ --fileman=/usr/bin/pcmanfm</command> 
	      </action>					       
	    </keybind>                                            
	    ...
	    <keybind key="XF86AudioPlay">                           
	      <action name="Execute">			       
		<command>/usr/bin/lxmusic</command> 
	      </action>					       
	    </keybind>                                            
